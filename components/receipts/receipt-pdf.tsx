        ...
        <View style={styles.document}>
          <View style={styles.header}>
            <View style={styles.brand}>
              ...
              <View>
                <Text style={styles.companyName}>{storeName || "JohannesJohn"}</Text>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>JohannesJohn - {storeLocation}</Text>
            <Text style={styles.footerText}>sales@johannesjohn.com - {storePhone}</Text>
          </View>
        </View>
      </Page>
    </Document>
