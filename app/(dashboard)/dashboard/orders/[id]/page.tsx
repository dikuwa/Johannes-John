    ...
    try {
      ...
      const emailRes = await fetch("/api/documents/send-email", {
        ...
        body: JSON.stringify({
          ...
          documentNumber: `RCP-${order.orderNumber.replace("DT-", "")}`,
          subject: `Receipt for ${order.orderNumber} - ${storeSettings?.storeName || "JohannesJohn"}`,
      ...
      if (emailData.success) {
        ...
        const subject = encodeURIComponent(`Receipt for ${order.orderNumber} - ${storeSettings?.storeName || "JohannesJohn"}`);
