...
export default async function TermsPage() {
  ...
  const storeEmail = settings.email || "sales@johannesjohn.com";
  return (
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
        <section>
          ...
          <p className="leading-relaxed">
            These terms govern the use of the JohannesJohn website and the purchase
        ...
        <section>
          ...
          <p className="leading-relaxed">
            JohannesJohn is not liable for indirect damages arising from the use or
