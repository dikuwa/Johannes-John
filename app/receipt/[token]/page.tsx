      ...
      <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
        <div className="flex items-center justify-between mb-6">
          <Link href="/" className="flex items-center gap-2">
            <svg viewBox="0 0 100 100" fill="none" className="h-8 w-8 shrink-0" aria-hidden="true">
            ...
            <span className="text-sm font-bold text-foreground">JohannesJohn</span>
          </Link>
        ...
        <div className="mt-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              href={buildWhatsAppUrl(storeSettings.whatsapp, `Hi JohannesJohn, I'm enquiring about my order ${data.orderNumber}.`)}
              target="_blank"
              rel="noopener noreferrer"
