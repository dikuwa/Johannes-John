...
function loadPdfLogo(): string | null {
  try {
    const logoPath = path.join(process.cwd(), "public", "images", "johannesjohn-logo-pdf.png");
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      ` : ""}
      <p style="color: #6f6f6f; font-size: 13px;">Thank you for choosing JohannesJohn!</p>
    </div>
    <div class="footer">
      <p>JohannesJohn | Namibia</p>
    </div>
  </div>
</body>
</html>
...
Thank you for choosing JohannesJohn!
    `.trim();
