...
function getPassword(envVar: string, label: string): string {
...
export const SYSTEM_USERS = [
  {
    name: "JohannesJohn Owner",
    email: "owner@johannesjohn.com",
    passwordEnvVar: "JOHANNESJOHN_OWNER_PASSWORD",
    role: UserRole.OWNER,
  },
  {
    name: "JohannesJohn Admin",
    email: "admin@johannesjohn.com",
    passwordEnvVar: "JOHANNESJOHN_ADMIN_PASSWORD",
    role: UserRole.ADMIN,
  },
  {
    name: "JohannesJohn Staff",
    email: "staff@johannesjohn.com",
    passwordEnvVar: "JOHANNESJOHN_STAFF_PASSWORD",
    role: UserRole.STAFF,
  },
] as const;
...
export async function ensureSystemUsers(
  ...
  for (const systemUser of SYSTEM_USERS) {
    const password = getPassword(systemUser.passwordEnvVar, systemUser.email);
